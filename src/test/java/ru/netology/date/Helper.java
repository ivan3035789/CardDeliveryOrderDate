...
public class Helper {
    ...
    public static String invalidCityZero() {
        return "";
    }
    ...
    public static String invalidNameZero() {
        return "";
    }
    ...
    public static String invalidData() {
        ...
        String invalidData2 = invalidData1.replace("1", "p");
        String invalidData3 = invalidData1.replace("", "44");
        Random randomInvalidData = new Random();
        String[] invalidData = {invalidData2, invalidData3};
        return invalidData[randomInvalidData.nextInt(invalidData.length)];
    }

    public static String invalidDataMinusDaysThree() {
    ...
    public static String phoneZero() {
        return faker.phoneNumber().subscriberNumber(0);
    }
